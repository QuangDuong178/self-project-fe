<template>
  ...
  <div class="h-full">
    <div id="choose-picture" class="w-full">
      <TransitionGroup :duration="2000" class="container" name="fade">
        <AvatarBoxMessages
          id="avatar-box-messages"
        ...
        />
        <ChoosePicture
          v-if="displayChoosePicture"
          :image-list="defaultPicture"
          class="pick-picture"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const choosePicture = (id: number) => {
      ...
      avatarMessageBox.style.top = '40vh';
    ...
    const loadMessage = setInterval(() => {
      ...
      switch (transition) {
        ...
        case 2: {
          avatarMessageBox.style.transform = 'translate(0, -10px)';
          break;
        }
        case 3: {
          avatarMessageBox.style.transform = 'translate(0, 10px)';
          messageList.value.push(defaultMessage[transition - 2]);
          break;
        }
        case 4: {
          avatarMessageBox.style.transform = 'translate(0, calc(10px - 35vh))';
          break;
        }
        default:
          displayChoosePicture.value = true;
